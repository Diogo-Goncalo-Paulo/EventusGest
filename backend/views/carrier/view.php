...
<div class="row bg-white profile-header">
    <div class="container">
        <div class="media position-relative" style="top:8rem">
            <div class="shadow radius-round border border-white overflow-hidden profile-image" style="background-image: url(<?= Yii::$app->request->baseUrl . '/uploads/' . $model->photo ?>)">
            </div>
