    ...
    <div class="card bg-transparent border-0 mb-3">
        <div class="card-header bg-transparent border-0 p-0">
            ...
            <div class="float-right mt-1">
                ...
                <?php if (Yii::$app->user->can('createEntityType')) {
                    echo Html::a('<i class="fas fa-plus"></i>', ['create'], ['data-toggle' => 'tooltip', 'class' => 'btn btn-outline-success radius-round', 'id' => 'btnCreate', 'title' => 'Novo Tipo de Entidade']);
                } ?>
            </div>
        </div>
