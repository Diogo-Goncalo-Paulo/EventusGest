...
/* @var $searchModel app\models\AccesspointSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Pontos de Acesso';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="accesspoint-index">
    ...
    <div class="card bg-transparent border-0 mb-3">
        <div class="card-header bg-transparent border-0 p-0">
            ...
            <div class="float-right mt-1">
                ...
                <?php if (Yii::$app->user->can('createAccessPoint')) {
                    echo Html::a('<i class="fas fa-plus"></i>', ['create'], ['data-toggle' => 'tooltip', 'class' => 'btn btn-outline-success radius-round', 'id' => 'btnCreate', 'title' => 'Novo Ponto de Acesso']);
                } ?>
            </div>
        </div>
